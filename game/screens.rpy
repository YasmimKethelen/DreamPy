...
style button:
    ...
    background None
    hover_background "#ffffff10"  # branco sutil translúcido
    xpadding 20
    ypadding 10
...
style button_text is gui_text:
    ...
    outlines [(2, "#00000080", 0, 0)]  # sombra preta sutil
...
style main_menu_vbox:
    xalign 0.85  # ajusta horizontalmente
    yalign 0.90  # ajusta verticalmente
    xoffset 0
    yoffset 50
    spacing 15
...
##Contador de acertos
screen contador_acertos():
    zorder 2 # Garante que a tela fique acima de outras telas
    frame:
        style "contador_frame"
        xalign 0.99
        yalign 0.05
        text "Acertos: [score]" style "contador_text"
...
screen score_display():
    frame:
        ...
        text "Acertos: [score]/5" size 30 color "#FFFFFF"

screen score_display2():
    frame:
        padding (10, 10)
        background "#0008"
        xalign 0.95 yalign 0.05
        text "Acertos: [score_adv]/5" size 30 color "#FFFFFF"
